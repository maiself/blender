...
#  ifdef __SPLIT_KERNEL__
		ccl_addr_space SubsurfaceIntersection *ss_isect = &kg->ss_isect[SD_THREAD];
#  else  /* __SPLIT_KERNEL__ */
		SubsurfaceIntersection ss_isect_object;
		SubsurfaceIntersection *ss_isect = &ss_isect_object;
